...
echo "  <script data-cfasync=\"false\" src=\"https://cdn.jsdelivr.net/npm/chart.js\"></script>" >> "$INDEX_HTML"
...
echo "      font-size: 0.9rem;" >> "$INDEX_HTML"
echo "    }" >> "$INDEX_HTML"
echo "    .placeholder-data {" >> "$INDEX_HTML"
echo "      background-color: rgba(255, 193, 7, 0.1);" >> "$INDEX_HTML"
echo "    }" >> "$INDEX_HTML"
echo "    .placeholder-data td {" >> "$INDEX_HTML"
echo "      font-style: italic;" >> "$INDEX_HTML"
echo "    }" >> "$INDEX_HTML"
echo "    .placeholder-badge {" >> "$INDEX_HTML"
echo "      background-color: #ff9800;" >> "$INDEX_HTML"
echo "      color: white;" >> "$INDEX_HTML"
echo "      padding: 0.25rem 0.75rem;" >> "$INDEX_HTML"
echo "      border-radius: 50px;" >> "$INDEX_HTML"
echo "      margin-left: 8px;" >> "$INDEX_HTML"
echo "      font-size: 0.8rem;" >> "$INDEX_HTML"
echo "      font-weight: 500;" >> "$INDEX_HTML"
echo "    }" >> "$INDEX_HTML"
echo "    .placeholder-warning {" >> "$INDEX_HTML"
echo "      background-color: #fff3cd;" >> "$INDEX_HTML"
echo "      color: #856404;" >> "$INDEX_HTML"
echo "      border-left: 4px solid #ffc107;" >> "$INDEX_HTML"
echo "      padding: 1rem;" >> "$INDEX_HTML"
echo "      margin: 1rem 0;" >> "$INDEX_HTML"
echo "      border-radius: 6px;" >> "$INDEX_HTML"
echo "    }" >> "$INDEX_HTML"
echo "    .placeholder-value {" >> "$INDEX_HTML"
echo "      text-decoration: underline wavy #ff9800;" >> "$INDEX_HTML"
echo "      text-decoration-thickness: 2px;" >> "$INDEX_HTML"
echo "      position: relative;" >> "$INDEX_HTML"
echo "    }" >> "$INDEX_HTML"
echo "    .clear-placeholder {" >> "$INDEX_HTML"
echo "      display: inline-block;" >> "$INDEX_HTML"
echo "      position: relative;" >> "$INDEX_HTML"
echo "    }" >> "$INDEX_HTML"
echo "    .clear-placeholder::after {" >> "$INDEX_HTML"
echo "      content: '⚠️';" >> "$INDEX_HTML"
echo "      position: absolute;" >> "$INDEX_HTML"
echo "      top: -7px;" >> "$INDEX_HTML"
echo "      right: -12px;" >> "$INDEX_HTML"
echo "      font-size: 11px;" >> "$INDEX_HTML"
echo "    }" >> "$INDEX_HTML"
echo "  </style>" >> "$INDEX_HTML"
echo "</head>" >> "$INDEX_HTML"
echo "<body>" >> "$INDEX_HTML"
...
echo "            </div>" >> "$INDEX_HTML"
echo "            <div id=\"placeholder-warning\" class=\"placeholder-warning\" style=\"display:none;\">" >> "$INDEX_HTML"
echo "              <h4><i class=\"bi bi-exclamation-triangle-fill me-2\"></i>Placeholder Data Detected</h4>" >> "$INDEX_HTML"
echo "              <p>Some of the data shown in this dashboard is <strong>placeholder data</strong>, not actual Lighthouse test results. This means that either:</p>" >> "$INDEX_HTML"
echo "              <ul>" >> "$INDEX_HTML"
echo "                <li>The Lighthouse tests failed to run successfully</li>" >> "$INDEX_HTML"
echo "                <li>The test results couldn't be retrieved or processed</li>" >> "$INDEX_HTML"
echo "                <li>There was an issue connecting to the test environment</li>" >> "$INDEX_HTML"
echo "              </ul>" >> "$INDEX_HTML"
echo "              <p><strong>The following values indicate placeholder data, not real test results:</strong></p>" >> "$INDEX_HTML"
echo "              <ul>" >> "$INDEX_HTML"
echo "                <li>Fixed performance scores of 50 for desktop and 40 for mobile</li>" >> "$INDEX_HTML"
echo "                <li>Identical scores of 50 for Accessibility, Best Practices, and SEO</li>" >> "$INDEX_HTML"
echo "                <li>Values of 42 (desktop) or 24 (mobile) for any metric</li>" >> "$INDEX_HTML"
echo "                <li>Identical LCP, FID, and CLS values across multiple pages</li>" >> "$INDEX_HTML"
echo "              </ul>" >> "$INDEX_HTML"
echo "            </div>" >> "$INDEX_HTML"
echo "          </div>" >> "$INDEX_HTML"
echo "        </div>" >> "$INDEX_HTML"
...
echo "        <div class=\"card\">" >> "$INDEX_HTML"
echo "          <div class=\"card-header\">" >> "$INDEX_HTML"
echo "            <h5 class=\"mb-0\"><i class=\"bi bi-info-circle me-2\"></i>Metrics Data Source</h5>" >> "$INDEX_HTML"
echo "          </div>" >> "$INDEX_HTML"
echo "          <div class=\"card-body\">" >> "$INDEX_HTML"
echo "            <div id=\"data-source-info\">" >> "$INDEX_HTML"
echo "              <p>Checking data source information...</p>" >> "$INDEX_HTML"
echo "            </div>" >> "$INDEX_HTML"
echo "            <pre id=\"data-paths\" class=\"mt-3 p-2 bg-light\" style=\"max-height: 200px; overflow: auto; font-size: 0.8rem;\"></pre>" >> "$INDEX_HTML"
echo "          </div>" >> "$INDEX_HTML"
echo "        </div>" >> "$INDEX_HTML"
echo "      </div>" >> "$INDEX_HTML"
...
echo "  <script data-cfasync=\"false\">" >> "$INDEX_HTML"
...
echo "          performance: 0," >> "$INDEX_HTML"
echo "          accessibility: 0," >> "$INDEX_HTML"
echo "          bestPractices: 0," >> "$INDEX_HTML"
echo "          seo: 0," >> "$INDEX_HTML"
echo "          metrics: {" >> "$INDEX_HTML"
echo "            LCP: 0," >> "$INDEX_HTML"
echo "            FID: 0," >> "$INDEX_HTML"
echo "            CLS: 0" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        }," >> "$INDEX_HTML"
...
echo "      try {" >> "$INDEX_HTML"
echo "        // Initialize with fallback data in case we can't load actual data" >> "$INDEX_HTML"
...
echo "        " >> "$INDEX_HTML"
echo "        console.log('Looking for actual Lighthouse data...');" >> "$INDEX_HTML"
echo "        " >> "$INDEX_HTML"
...
echo "          let foundData = false;" >> "$INDEX_HTML"
echo "          let successfulPath = '';" >> "$INDEX_HTML"
echo "          let attemptedPaths = [];" >> "$INDEX_HTML"
echo "          " >> "$INDEX_HTML"
echo "          // Try each possible path" >> "$INDEX_HTML"
echo "          for (let j = 0; j < possiblePaths.length; j++) {" >> "$INDEX_HTML"
echo "            if (foundData) continue;" >> "$INDEX_HTML"
echo "            " >> "$INDEX_HTML"
echo "            const pathTemplate = possiblePaths[j];" >> "$INDEX_HTML"
echo "            const fetchUrl = pathTemplate.replace('%PAGE%', pageName);" >> "$INDEX_HTML"
echo "            attemptedPaths.push(fetchUrl);" >> "$INDEX_HTML"
echo "            " >> "$INDEX_HTML"
echo "            try {" >> "$INDEX_HTML"
echo "              console.log('Attempting to fetch data for ' + pageName + ' from: ' + fetchUrl);" >> "$INDEX_HTML"
echo "              const response = await fetch(fetchUrl, { cache: 'no-store' });" >> "$INDEX_HTML"
echo "              if (response.ok) {" >> "$INDEX_HTML"
echo "                const text = await response.text();" >> "$INDEX_HTML"
echo "                console.log('Received data for ' + pageName + ': ' + text.substring(0, 100) + '...');" >> "$INDEX_HTML"
echo "                " >> "$INDEX_HTML"
echo "                try {" >> "$INDEX_HTML"
echo "                  // Manually validate JSON to avoid syntax errors" >> "$INDEX_HTML"
echo "                  if (text.trim()) {" >> "$INDEX_HTML"
echo "                    const cleanedText = text.replace(/\\n/g, ' ').trim();" >> "$INDEX_HTML"
echo "                    const data = JSON.parse(cleanedText);" >> "$INDEX_HTML"
echo "                    " >> "$INDEX_HTML"
echo "                    // Replace the existing entry for this page in the array" >> "$INDEX_HTML"
echo "                    const existingIndex = performanceData.pages.findIndex(p => p.name === pageName);" >> "$INDEX_HTML"
echo "                    if (existingIndex >= 0) {" >> "$INDEX_HTML"
echo "                      performanceData.pages[existingIndex] = data;" >> "$INDEX_HTML"
echo "                    } else {" >> "$INDEX_HTML"
echo "                      performanceData.pages.push(data);" >> "$INDEX_HTML"
echo "                    }" >> "$INDEX_HTML"
echo "                    loadedActualData = true;" >> "$INDEX_HTML"
echo "                    foundData = true;" >> "$INDEX_HTML"
echo "                    successfulPath = fetchUrl;" >> "$INDEX_HTML"
echo "                    console.log('Successfully loaded data for ' + pageName + ' from ' + fetchUrl);" >> "$INDEX_HTML"
echo "                  } else {" >> "$INDEX_HTML"
echo "                    console.warn('Empty JSON response for ' + pageName);" >> "$INDEX_HTML"
echo "                  }" >> "$INDEX_HTML"
echo "                } catch (jsonError) {" >> "$INDEX_HTML"
echo "                  console.error('JSON parse error for ' + pageName + ':', jsonError, text.substring(0, 200));" >> "$INDEX_HTML"
echo "                }" >> "$INDEX_HTML"
echo "              } else {" >> "$INDEX_HTML"
echo "                console.warn('Failed to fetch data for ' + pageName + ' from ' + fetchUrl + ', status: ' + response.status);" >> "$INDEX_HTML"
echo "              }" >> "$INDEX_HTML"
echo "            } catch (fetchError) {" >> "$INDEX_HTML"
echo "              console.error('Error fetching data for ' + pageName + ' from ' + fetchUrl + ':', fetchError);" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
echo "        " >> "$INDEX_HTML"
...
echo "            warningBanner.className = 'alert alert-danger mb-4';" >> "$INDEX_HTML"
echo "            warningBanner.innerHTML = '<strong>Warning:</strong> Displaying placeholder data (all zeros). Actual Lighthouse CI results could not be loaded. Check browser console for details.';" >> "$INDEX_HTML"
echo "            headerEl.after(warningBanner);" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        } else {" >> "$INDEX_HTML"
echo "          const headerEl = document.querySelector('.dashboard-header');" >> "$INDEX_HTML"
echo "          if (headerEl) {" >> "$INDEX_HTML"
echo "            const successBanner = document.createElement('div');" >> "$INDEX_HTML"
echo "            successBanner.className = 'alert alert-success mb-4';" >> "$INDEX_HTML"
echo "            successBanner.innerHTML = '<strong>Success:</strong> Displaying actual Lighthouse CI report data.';" >> "$INDEX_HTML"
echo "            headerEl.after(successBanner);" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
echo "        " >> "$INDEX_HTML"
echo "        // Update data source information section" >> "$INDEX_HTML"
echo "        const dataSourceInfo = document.getElementById('data-source-info');" >> "$INDEX_HTML"
echo "        const dataPathsEl = document.getElementById('data-paths');" >> "$INDEX_HTML"
echo "        " >> "$INDEX_HTML"
echo "        if (dataSourceInfo && dataPathsEl) {" >> "$INDEX_HTML"
echo "          let sourceInfoHtml = '';" >> "$INDEX_HTML"
echo "          let pathsInfo = 'Attempted paths:\n\n';" >> "$INDEX_HTML"
echo "
          // Collect all attempted paths for each page
          const allPaths = {};" >> "$INDEX_HTML"
echo "          for (const path of possiblePaths) {" >> "$INDEX_HTML"
echo "            for (const page of pageNames) {" >> "$INDEX_HTML"
echo "              const fullPath = path.replace('%PAGE%', page);" >> "$INDEX_HTML"
echo "              if (!allPaths[page]) allPaths[page] = [];" >> "$INDEX_HTML"
echo "              allPaths[page].push(fullPath);" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "
          // Add paths to the debug info
          for (const page in allPaths) {" >> "$INDEX_HTML"
echo "            pathsInfo += page + ':\n';" >> "$INDEX_HTML"
echo "            for (const path of allPaths[page]) {" >> "$INDEX_HTML"
echo "              pathsInfo += '- ' + path + '\n';" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "            pathsInfo += '\n';" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "
          // Check if any page has suspicious fixed values (all 50s or 40s)
          let hasAllFixedValues = true;" >> "$INDEX_HTML"
...
echo "                page.is_placeholder_data = {
                  desktop: hasFixedDesktopValues,
                  mobile: hasFixedMobileValues
                };" >> "$INDEX_HTML"
echo "              } else {" >> "$INDEX_HTML"
echo "                if (hasFixedDesktopValues) page.is_placeholder_data.desktop = true;" >> "$INDEX_HTML"
echo "                if (hasFixedMobileValues) page.is_placeholder_data.mobile = true;" >> "$INDEX_HTML"
echo "              }" >> "$INDEX_HTML"
echo "            } else {" >> "$INDEX_HTML"
echo "              hasAllFixedValues = false;" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "
...
echo "            } else {" >> "$INDEX_HTML"
echo "              sourceInfoHtml += '<div class=\"alert alert-success\"><strong>Success:</strong> Data loaded from actual Lighthouse CI reports.</div>';" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "
...
echo "              const hasFixedDesktopValues =
              ...
              // Update placeholder flags based on fixed values
              if (hasFixedDesktopValues || hasFixedMobileValues) {" >> "$INDEX_HTML"
...
echo "              }" >> "$INDEX_HTML"
echo "
              // Check if page data is placeholder data
              const isDesktopPlaceholder = hasFixedDesktopValues || page.is_placeholder_data?.desktop === true;
              const isMobilePlaceholder = hasFixedMobileValues || page.is_placeholder_data?.mobile === true;

              if (isDesktopPlaceholder && isMobilePlaceholder) {" >> "$INDEX_HTML"
echo "                sourceInfoHtml += '<li><strong>' + page.name + ':</strong> <span class=\"text-danger\">Using placeholder data for all devices</span>';" >> "$INDEX_HTML"
echo "                if (hasFixedDesktopValues) sourceInfoHtml += ' (desktop values: performance=' + page.desktop.performance + ', all other scores=50)';" >> "$INDEX_HTML"
echo "                if (hasFixedMobileValues) sourceInfoHtml += ' (mobile values: performance=' + page.mobile.performance + ', all other scores=50)';" >> "$INDEX_HTML"
echo "                sourceInfoHtml += '</li>';" >> "$INDEX_HTML"
echo "              } else if (isDesktopPlaceholder) {" >> "$INDEX_HTML"
echo "                sourceInfoHtml += '<li><strong>' + page.name + ':</strong> <span class=\"text-warning\">Using placeholder data for desktop</span>';" >> "$INDEX_HTML"
echo "                if (hasFixedDesktopValues) sourceInfoHtml += ' (fixed values: performance=' + page.desktop.performance + ', all other scores=50)';" >> "$INDEX_HTML"
echo "                sourceInfoHtml += '</li>';" >> "$INDEX_HTML"
echo "              } else if (isMobilePlaceholder) {" >> "$INDEX_HTML"
echo "                sourceInfoHtml += '<li><strong>' + page.name + ':</strong> <span class=\"text-warning\">Using placeholder data for mobile</span>';" >> "$INDEX_HTML"
echo "                if (hasFixedMobileValues) sourceInfoHtml += ' (fixed values: performance=' + page.mobile.performance + ', all other scores=50)';" >> "$INDEX_HTML"
echo "                sourceInfoHtml += '</li>';" >> "$INDEX_HTML"
echo "              } else if (page.desktop?.performance > 0 || page.mobile?.performance > 0) {" >> "$INDEX_HTML"
echo "                sourceInfoHtml += '<li><strong>' + page.name + ':</strong> <span class=\"text-success\">Using actual metrics data</span></li>';" >> "$INDEX_HTML"
echo "              } else {" >> "$INDEX_HTML"
echo "                sourceInfoHtml += '<li><strong>' + page.name + ':</strong> <span class="text-secondary">Using fallback data</span></li>';" >> "$INDEX_HTML"
echo "              }" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "            sourceInfoHtml += '</ul>';" >> "$INDEX_HTML"
echo "          } else {" >> "$INDEX_HTML"
echo "            if (hasAllFixedValues) {" >> "$INDEX_HTML"
echo "              sourceInfoHtml += '<div class=\"alert alert-danger\"><strong>Warning:</strong> All data appears to be placeholder values (fixed scores of 50/40). This likely means that:</div>';" >> "$INDEX_HTML"
echo "              sourceInfoHtml += '<ul class=\"text-danger\">';" >> "$INDEX_HTML"
echo "              sourceInfoHtml += '<li>The Lighthouse tests did not run properly, or</li>';" >> "$INDEX_HTML"
echo "              sourceInfoHtml += '<li>The report files were found but contain default values instead of actual test results, or</li>';" >> "$INDEX_HTML"
echo "              sourceInfoHtml += '<li>The dashboard is unable to access the actual test results and is showing fallback data</li>';" >> "$INDEX_HTML"
echo "              sourceInfoHtml += '</ul>';" >> "$INDEX_HTML"
echo "            } else {" >> "$INDEX_HTML"
echo "              sourceInfoHtml += '<div class=\"alert alert-danger\"><strong>Error:</strong> Failed to load any actual Lighthouse CI data. Using placeholder values.</div>';" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "
            sourceInfoHtml += '<div class=\"mt-3 p-3 bg-light border rounded\">';" >> "$INDEX_HTML"
echo "            sourceInfoHtml += '<p><strong>Troubleshooting:</strong></p>';" >> "$INDEX_HTML"
echo "            sourceInfoHtml += '<ol>';" >> "$INDEX_HTML"
echo "            sourceInfoHtml += '<li>Check that the Lighthouse CI action ran successfully in the GitHub Actions workflow</li>';" >> "$INDEX_HTML"
echo "            sourceInfoHtml += '<li>Verify that report files were generated in the expected locations</li>';" >> "$INDEX_HTML"
echo "            sourceInfoHtml += '<li>Try running the workflow again with debug logs enabled</li>';" >> "$INDEX_HTML"
echo "            sourceInfoHtml += '</ol>';" >> "$INDEX_HTML"
echo "            sourceInfoHtml += '</div>';" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "
          dataSourceInfo.innerHTML = sourceInfoHtml;" >> "$INDEX_HTML"
echo "          dataPathsEl.textContent = pathsInfo;" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
...
echo "      let hasPlaceholderData = false;" >> "$INDEX_HTML"
...
echo "            '<td>' + (isPlaceholder ? '<span class=\"clear-placeholder\">' : '') + formatScore(page.desktop.performance) + (isPlaceholder ? '</span>' : '') + '</td>' +" >> "$INDEX_HTML"
echo "            '<td>' + (isPlaceholder ? '<span class=\"clear-placeholder\">' : '') + formatScore(page.desktop.accessibility) + (isPlaceholder ? '</span>' : '') + '</td>' +" >> "$INDEX_HTML"
echo "            '<td>' + (isPlaceholder ? '<span class=\"clear-placeholder\">' : '') + formatScore(page.desktop.bestPractices) + (isPlaceholder ? '</span>' : '') + '</td>' +" >> "$INDEX_HTML"
echo "            '<td>' + (isPlaceholder ? '<span class=\"clear-placeholder\">' : '') + formatScore(page.desktop.seo) + (isPlaceholder ? '</span>' : '') + '</td>' +" >> "$INDEX_HTML"
echo "            '<td><span class=\"pill ' + getMetricClass('LCP', page.desktop.metrics.LCP) + (isPlaceholder ? ' clear-placeholder' : '') + '\">' + formatTime(page.desktop.metrics.LCP) + '</span></td>' +" >> "$INDEX_HTML"
echo "            '<td><span class=\"pill ' + getMetricClass('FID', page.desktop.metrics.FID) + (isPlaceholder ? ' clear-placeholder' : '') + '\">' + page.desktop.metrics.FID + 'ms</span></td>' +" >> "$INDEX_HTML"
echo "            '<td><span class=\"pill ' + getMetricClass('CLS', page.desktop.metrics.CLS) + (isPlaceholder ? ' clear-placeholder' : '') + '\">' + page.desktop.metrics.CLS + '</span></td>' +" >> "$INDEX_HTML"
...
echo "            '<td>' + (isPlaceholder ? '<span class=\"clear-placeholder\">' : '') + formatScore(page.mobile.performance) + (isPlaceholder ? '</span>' : '') + '</td>' +" >> "$INDEX_HTML"
echo "            '<td>' + (isPlaceholder ? '<span class=\"clear-placeholder\">' : '') + formatScore(page.mobile.accessibility) + (isPlaceholder ? '</span>' : '') + '</td>' +" >> "$INDEX_HTML"
echo "            '<td>' + (isPlaceholder ? '<span class=\"clear-placeholder\">' : '') + formatScore(page.mobile.bestPractices) + (isPlaceholder ? '</span>' : '') + '</td>' +" >> "$INDEX_HTML"
echo "            '<td>' + (isPlaceholder ? '<span class=\"clear-placeholder\">' : '') + formatScore(page.mobile.seo) + (isPlaceholder ? '</span>' : '') + '</td>' +" >> "$INDEX_HTML"
echo "            '<td><span class=\"pill ' + getMetricClass('LCP', page.mobile.metrics.LCP) + (isPlaceholder ? ' clear-placeholder' : '') + '\">' + formatTime(page.mobile.metrics.LCP) + '</span></td>' +" >> "$INDEX_HTML"
echo "            '<td><span class=\"pill ' + getMetricClass('FID', page.mobile.metrics.FID) + (isPlaceholder ? ' clear-placeholder' : '') + '\">' + page.mobile.metrics.FID + 'ms</span></td>' +" >> "$INDEX_HTML"
echo "            '<td><span class=\"pill ' + getMetricClass('CLS', page.mobile.metrics.CLS) + (isPlaceholder ? ' clear-placeholder' : '') + '\">' + page.mobile.metrics.CLS + '</span></td>' +" >> "$INDEX_HTML"
echo "            '<td><a href=\"./' + performanceData.date + '/' + page.name + '/mobile.html\" class=\"btn-detail\">View Report</a></td>';" >> "$INDEX_HTML"
echo "          tableBody.appendChild(tr);" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
echo "      });" >> "$INDEX_HTML"
echo "      " >> "$INDEX_HTML"
echo "      // Show warning if there's placeholder data" >> "$INDEX_HTML"
echo "      if (hasPlaceholderData) {" >> "$INDEX_HTML"
echo "        document.getElementById('placeholder-warning').style.display = 'block';" >> "$INDEX_HTML"
echo "      }" >> "$INDEX_HTML"
...
echo "      const desktopScores = { perf: 0, a11y: 0, bp: 0, seo: 0, count: 0, placeholder: false };" >> "$INDEX_HTML"
echo "      const mobileScores = { perf: 0, a11y: 0, bp: 0, seo: 0, count: 0, placeholder: false };" >> "$INDEX_HTML"
echo "      " >> "$INDEX_HTML"
echo "      performanceData.pages.forEach(page => {" >> "$INDEX_HTML"
echo "        if (page.desktop) {" >> "$INDEX_HTML"
...
echo "            desktopScores.placeholder = true;" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
echo "        if (page.mobile) {" >> "$INDEX_HTML"
...
echo "          if (page.is_placeholder_data?.mobile === true) {" >> "$INDEX_HTML"
echo "            mobileScores.placeholder = true;" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
echo "      });" >> "$INDEX_HTML"
echo "      " >> "$INDEX_HTML"
...
echo "            {" >> "$INDEX_HTML"
echo "              label: 'Desktop' + (desktopScores.placeholder ? ' (Placeholder Data)' : '')," >> "$INDEX_HTML"
...
echo "            }," >> "$INDEX_HTML"
echo "            {" >> "$INDEX_HTML"
echo "              label: 'Mobile' + (mobileScores.placeholder ? ' (Placeholder Data)' : '')," >> "$INDEX_HTML"
...
echo "            title: {" >> "$INDEX_HTML"
echo "              display: true," >> "$INDEX_HTML"
echo "              text: 'Desktop vs Mobile Performance' + ((desktopScores.placeholder || mobileScores.placeholder) ? ' (Contains Placeholder Data)' : '')" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
echo "      });" >> "$INDEX_HTML"
...
echo "          datasets: [" >> "$INDEX_HTML"
echo "            {" >> "$INDEX_HTML"
echo "              label: 'Performance Score' + (hasPlaceholderData ? ' (Some Data is Placeholder)' : '')," >> "$INDEX_HTML"
...
echo "            title: {" >> "$INDEX_HTML"
echo "              display: true," >> "$INDEX_HTML"
echo "              text: 'Page Performance Comparison' + (hasPlaceholderData ? ' (Contains Placeholder Data)' : '')" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
echo "      });" >> "$INDEX_HTML"
