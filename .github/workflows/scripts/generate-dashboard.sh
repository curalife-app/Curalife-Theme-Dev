...
echo "          try {" >> "$INDEX_HTML"
echo "            console.log('Attempting to fetch data for ' + pageName);" >> "$INDEX_HTML"
echo "            const fetchUrl = './' + pageName + '-details/metrics-values.json';" >> "$INDEX_HTML"
...
echo "                  console.log('Successfully loaded data for ' + pageName);" >> "$INDEX_HTML"
echo "                } else {" >> "$INDEX_HTML"
echo "                  console.warn('Empty JSON response for ' + pageName);" >> "$INDEX_HTML"
echo "                }" >> "$INDEX_HTML"
echo "              } catch (jsonError) {" >> "$INDEX_HTML"
echo "                console.error('JSON parse error for ' + pageName + ':', jsonError);" >> "$INDEX_HTML"
echo "              }" >> "$INDEX_HTML"
echo "            } else {" >> "$INDEX_HTML"
echo "              console.warn('Failed to fetch data for ' + pageName + ', status: ' + response.status);" >> "$INDEX_HTML"
echo "            }" >> "$INDEX_HTML"
echo "          } catch (fetchError) {" >> "$INDEX_HTML"
echo "            console.error('Error fetching data for ' + pageName + ':', fetchError);" >> "$INDEX_HTML"
echo "          }" >> "$INDEX_HTML"
echo "        }" >> "$INDEX_HTML"
echo "        " >> "$INDEX_HTML"
