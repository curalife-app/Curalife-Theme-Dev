...
echo "              console.log(`Raw JSON for \${pageName}:`, text);" >> "$INDEX_HTML"
echo "              try {" >> "$INDEX_HTML"
echo "                const data = JSON.parse(text);" >> "$INDEX_HTML"
...
echo "                console.error(`JSON parse error for \${pageName}:`, jsonError, text);" >> "$INDEX_HTML"
